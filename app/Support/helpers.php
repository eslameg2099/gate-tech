...
if (! function_exists('price')) {
    /**
     * Retrieve the given price
     *
     * @param mixed $price
     * @return string
     */
    function price(mixed $price, $default = '---')
    {
        if (! is_null($price)) {
            return $price.' '.Settings::get('currency');
        }
...
if (! function_exists('price_string')) {
    /**
     * Retrieve the given price as string
     *
     * @param mixed $price
     * @return string
     */
    function price_string(mixed $price): string
    {
        return Numbers::TafqeetMoney(abs($price), Settings::get('currency'));
    }
}
