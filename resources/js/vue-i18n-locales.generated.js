export default {
    "ar": {
        ...
        "months.": "months.",
        "صندوق البناية": "صندوق البناية",
        "صندوق المالك": "صندوق المالك",
        "صندوق شركة الادارة": "صندوق شركة الادارة",
        "شركة الادارة": "شركة الادارة",
        "لم يقم بالدفع حتى الان": "لم يقم بالدفع حتى الان",
        "New user has been registered.": "تم تسحيل حساب جديد",
        "اضافة سند صرف": "اضافة سند صرف",
        "اضافة سند قبض": "اضافة سند قبض",
        "تقارير المصروفات": "تقارير المصروفات",
        ...
        "الاجمالي": "الاجمالي",
        "الرصيد": "الرصيد",
        "بحث في التقارير": "بحث في التقارير",
        "التقارير الشهرية": "التقارير الشهرية",
        "التقارير السنوية": "التقارير السنوية",
        ...
        "reports": {
            ...
            "deposits": "ايداعات",
            "titles": {
                "monthly-expenses": "مصروفات {building} {month} {year}",
                "monthly-deposits": "ايداعات {building} {month} {year}",
                "yearly-expenses": "مصروفات {building} {year}",
                "yearly-deposits": "ايداعات {building} {year}"
            }
        },
        "users": {
            "plural": "العضويات",
    ...
    "en": {
        ...
        "months.": "months.",
        "صندوق البناية": "Building Wallet",
        "صندوق المالك": "Owner Wallet",
        "صندوق شركة الادارة": "System Wallet",
        "شركة الادارة": "System",
        "لم يقم بالدفع حتى الان": "has not paid yet",
        "New user has been registered.": "New user has been registered.",
        "اضافة سند صرف": "Add Debit Receipt",
        "اضافة سند قبض": "Add Catch Receipt",
        "تقارير المصروفات": "Expense reports",
        "اختر التاريخ": "Select Date",
        "عرض التقارير": "Show Reports",
        ...
        "الاجمالي": "Total",
        "الرصيد": "Balance",
        "بحث في التقارير": "Search In Reports",
        "التقارير الشهرية": "Monthly Reports",
        "التقارير السنوية": "Yearly Reports",
        ...
        "reports": {
            ...
            "deposits": "Deposits",
            "titles": {
                "monthly-expenses": "{building} expenses for {month} {year}",
                "monthly-deposits": "{building} deposits for {month} {year}",
                "yearly-expenses": "{building} expenses for {year}",
                "yearly-deposits": "{building} deposits for {year}"
            }
        },
        "users": {
            "plural": "Accounts",
