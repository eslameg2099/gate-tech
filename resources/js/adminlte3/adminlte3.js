...
Vue.component('apartment-select', require('../components/ApartmentSelectComponent').default);
Vue.component('invoice-form', require('../components/InvoiceFormComponent').default);
Vue.component('datepicker', require('../components/DatepickerComponent').default);
Vue.component('date-time-picker', require('../components/DateTimePickerComponent').default);
Vue.component('date-range-picker', require('../components/DateRangePickerComponent').default);
